...
const Register = () => {
    const paperStyle = { padding: 20, width: 380, margin: "0 auto" }
    ...
    const validationSchema = Yup.object().shape({
        ...
        role: Yup.string().typeError("Enter your Qualification").required("Required"),
                    ...
                    {(props) => (
                        <Form>
                            ...
                            <Field as={TextField} fullWidth name="phoneNumber" label='Phone Number'
                             ...
                             <Field as={TextField} fullWidth name="role" label='Role'
                                placeholder="Enter your role" helperText={<ErrorMessage name="role" />} />
